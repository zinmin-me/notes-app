    ...
    <div class="relative z-10 w-full max-w-md px-4 sm:px-6 lg:px-8 py-12">
      <div class="glass-panel p-8 sm:p-10 rounded-3xl animate-fade-in">
        ...
        <form class="space-y-5" @submit.prevent="handleRegister">
          ...
          <div class="pt-2">
            <button type="submit" :disabled="authStore.loading" class="relative w-full btn-primary py-3 text-base shadow-primary-500/30 bg-gradient-to-r from-indigo-500 to-teal-500 hover:from-indigo-600 hover:to-teal-600 focus:ring-teal-500">
